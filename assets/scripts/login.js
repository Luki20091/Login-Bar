    ...
    auth.createUserWithEmailAndPassword(email, password)
        .then(function () {
            ...
            return firebase.database().ref('/users/' + userId).once('value').then((snapshot) => {
                ...
                document.getElementById("register-check-true").innerHTML = "Zarejestrowano&nbsp;użytkownika:&nbsp;" + username;
...
function login() {
    ...
    auth.signInWithEmailAndPassword(email, password)
        .then(function () {
            ...
            return firebase.database().ref('/users/' + userId).once('value').then((snapshot) => {
                var username = (snapshot.val() && snapshot.val().lp1_username) || 'Anonymous';
                document.getElementById("login-check-true").innerHTML = "Zalogowano&nbsp;użytkownika:&nbsp;" + username;
                ...
                document.getElementById("row-center").style.display = "block";
